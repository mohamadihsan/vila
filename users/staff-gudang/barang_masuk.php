    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Barang Masuk ke Gudang</li>
            </ul><!-- /.breadcrumb -->
        </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="" class="collapse tampil">
                        <div class="well">
                            <form action="../action/barang_masuk.php" method="post" class="myform">
                    ...
                    <div class="table-header">
                        Daftar data "Barang Masuk ke Gudang"
                    </div>
        ...
        <div class="modal-content">
            ...
            <form method="post" action="../action/persediaan.php" class="myform">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="barang" value="masuk" readonly>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#mytable').DataTable({
                    "bProcessing": true,
                    "sAjaxSource": "<?php echo $base_url.'action/tampilkan_data_persediaan.php?status=masuk' ?>",
                    "deferRender": true,
                    "select": true,
                    //"dom": 'Bfrtip',
                    //"scrollY": "300",
