            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="table-header">
                        Daftar data "Pemesanan Bahan Makanan"
                    </div>
...
<div class="modal fade" id="hapus" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form method="post" action="../action/pemesanan_bahan_makanan.php" class="myform">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#mytable').DataTable({
                    "bProcessing": true,
                    "sAjaxSource": "<?php echo $base_url.'action/tampilkan_data_pemesanan_bahan_makanan.php' ?>",
                    "deferRender": true,
                    "select": true,
                    //"dom": 'Bfrtip',
                    //"scrollY": "300",
