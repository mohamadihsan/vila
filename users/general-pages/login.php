						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Vila</span>
									<span class="white" id="id-text2">Air Natural Resort</span>
								</h1>
								...
								<div id="signup-box" class="signup-box widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form method="post" action="action/registrasi.php" class="myform">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" name="ulangi_kata_sandi" placeholder="Ulangi Kata Sandi" required/>
