...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $sub_array['ubah_gambar'] = '  <a href="" title="Ubah Gambar" data-toggle="modal" data-target="#ubahGambar" onclick="return ubahGambar(\''.$row['id_menu'].'\',\''.$row['gambar_menu'].'\')"><i class="ace-icon fa fa-picture-o bigger-120"></i></a>';
